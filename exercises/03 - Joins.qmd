...
# Access tables
diagnoses_icd9 <- tbl(mimic, "d_icd_diagnoses") |> filter(icd_version == 9) |> collect() |> sample_n(2000)
diagnoses_icd10 <- tbl(mimic, "d_icd_diagnoses") |> filter(icd_version == 10) |> collect() |> sample_n(2000)
